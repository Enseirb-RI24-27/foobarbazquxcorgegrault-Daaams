...
class FooTest {
    ...
    static void beforeAll() {
        FooTest.fooClass = Utils.testIfClassExists("com.jad.jad.jad.Foo");
        FooTest.barClass = assertDoesNotThrow(() -> ClassLoader.getSystemClassLoader().loadClass("com.jad.jad.jad.Bar"),
    ...
    void barAttributeTest() {
        Utils.testIfPrivateAttributeExistsWithGoodType("com.jad.jad.jad.Bar",
                                                       "bar",
                                                       FooTest.fooClass);
    }
    ...
    void bazsAttributeTest() {
        Utils.testIfPrivateAttributeExistsWithGenericType("java.util.List<com.jad.jad.jad.Baz>",
                                                          "bazs",
                                                          FooTest.fooClass);
    }
    ...
    void quxAttributeTest() {
        Utils.testIfPrivateAttributeExistsWithGoodType("com.jad.jad.jad.Qux",
                                                       "qux",
                                                       FooTest.fooClass);
    }
    ...
    void graultsAttributeTest() {
        Utils.testIfPrivateAttributeExistsWithGenericType("java.util.List<com.jad.jad.jad.Grault>",
                                                          "graults",
                                                          FooTest.fooClass);
    }
    ...
    void constructorTest() {
        ...
        assertEquals(FooTest.NB_OF_CONSTRUCTOR, constructors.length,
                     "The class jad.jad.Foo should have only " + FooTest.NB_OF_CONSTRUCTOR + " constructor.");
        Constructor<?> constructor = constructors[0];
        Class<?>[] parameterTypes = constructor.getParameterTypes();
        assertEquals(FooTest.NB_CONSTRUCTOR_PARAMETERS, parameterTypes.length,
                     "The constructor of jad.jad.Foo should have " + FooTest.NB_CONSTRUCTOR_PARAMETERS + " parameter.");
        assertEquals(FooTest.barClass, parameterTypes[0], "The parameter of the constructor should be of type jad.jad.Bar.");
    ...
    void addBazAndGetBazsTest() {
        Class<?> bazClass = assertDoesNotThrow(() -> ClassLoader.getSystemClassLoader().loadClass("com.jad.jad.jad.Baz"),
                                               "The class jad.jad.Baz does not exist.");
        ...
        Object bazInstance = assertDoesNotThrow(() -> bazClass.getDeclaredConstructor().newInstance(),
                                                "Failed to create an instance of jad.jad.Baz.");
        ...
        assertTrue(bazs.contains(bazInstance), "The 'bazs' list does not contain the added jad.jad.Baz instance.");
    }
    ...
    void getCorgeAndSetCorgeTest() {
        Class<?> corgeClass = assertDoesNotThrow(() -> ClassLoader.getSystemClassLoader().loadClass("com.jad.jad.jad.Corge"),
                                                 "The class jad.jad.Corge does not exist.");
        ...
        Object corgeInstance1 = assertDoesNotThrow(
                ...
                "Failed to create an instance of jad.jad.Corge.");
        Object corgeInstance2 = assertDoesNotThrow(
                () -> corgeClass.getDeclaredConstructor(FooTest.fooClass).newInstance(FooTest.fooInstance),
                "Failed to create an instance of jad.jad.Corge.");
        assertDoesNotThrow(() -> setCorgeMethod.invoke(FooTest.fooInstance, corgeInstance1),
                           "Failed to invoke the method 'setCorge' with the first jad.jad.Corge instance.");
        Object returnedCorge1 = assertDoesNotThrow(() -> getCorgeMethod.invoke(FooTest.fooInstance),
                                                   "Failed to invoke the method 'getCorge' after setting the first jad.jad.Corge instance.");
        assertEquals(corgeInstance1, returnedCorge1,
                     "The method 'getCorge' did not return the correct jad.jad.Corge instance.");
        Object returnedFoo1 = assertDoesNotThrow(() -> getFooMethod.invoke(corgeInstance1),
                                                 "Failed to invoke the method 'getFoo' on the first jad.jad.Corge instance.");
        assertEquals(FooTest.fooInstance, returnedFoo1,
                     "The method 'getFoo' on the first jad.jad.Corge instance did not return the correct jad.jad.Foo instance.");
        assertDoesNotThrow(() -> setCorgeMethod.invoke(FooTest.fooInstance, corgeInstance2),
                           "Failed to invoke the method 'setCorge' with the second jad.jad.Corge instance.");
        Object returnedCorge2 = assertDoesNotThrow(() -> getCorgeMethod.invoke(FooTest.fooInstance),
                                                   "Failed to invoke the method 'getCorge' after setting the second jad.jad.Corge instance.");
        assertEquals(corgeInstance2, returnedCorge2,
                     "The method 'getCorge' did not return the correct jad.jad.Corge instance after setting the second jad.jad.Corge instance.");
        Object returnedFoo2 = assertDoesNotThrow(() -> getFooMethod.invoke(corgeInstance2),
                                                 "Failed to invoke the method 'getFoo' on the second jad.jad.Corge instance.");
        assertEquals(FooTest.fooInstance, returnedFoo2,
                     "The method 'getFoo' on the second jad.jad.Corge instance did not return the correct jad.jad.Foo instance.");
        Object returnedFoo1AfterSet = assertDoesNotThrow(() -> getFooMethod.invoke(corgeInstance1),
                                                         "Failed to invoke the method 'getFoo' on the first jad.jad.Corge instance after setting the second jad.jad.Corge instance.");
        assertNull(returnedFoo1AfterSet,
                   "The method 'getFoo' on the first jad.jad.Corge instance should return null after setting the second jad.jad.Corge instance.");
    }
    ...
    void addGraultTest() {
        ...
        Method getGraultsMethod = assertDoesNotThrow(() -> FooTest.fooClass.getDeclaredMethod("getGraults"),
                                                     "The method 'getGraults' does not exist.");
        Method getFooMethod = assertDoesNotThrow(() -> ClassLoader.getSystemClassLoader().loadClass("com.jad.jad.jad.Grault")
                                                         .getDeclaredMethod("getFoo"),
                                                 "The method 'getFoo' does not exist in jad.jad.Grault class.");

        // Add a new jad.jad.Grault
        ...
        assertFalse(graults.isEmpty(), "The 'graults' list should not be empty after adding a jad.jad.Grault.");

        // Verify the last added jad.jad.Grault
        Object lastGrault = graults.getLast();
        Object returnedFoo = assertDoesNotThrow(() -> getFooMethod.invoke(lastGrault),
                                                "Failed to invoke the method 'getFoo' on the last added jad.jad.Grault.");
        assertEquals(FooTest.fooInstance, returnedFoo,
                     "The method 'getFoo' on the last added jad.jad.Grault did not return the correct jad.jad.Foo instance.");
    }
}
